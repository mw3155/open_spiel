...
from open_spiel.python.games import schafkopf  # pylint: disable=unused-import
from open_spiel.python.observation import make_observation
import pyspiel


class SchafkopfTest(absltest.TestCase):

  def test_game_from_cc(self):
    """Runs our standard game tests, checking API consistency."""
    game = pyspiel.load_game("python_schafkopf")
  ...
  def test_consistent(self):
    ...
    """
    py_game = pyspiel.load_game("python_schafkopf")
    cc_game = pyspiel.load_game("schafkopf")
