...
from open_spiel.python.games import new_game
...
class NewGameTest(absltest.TestCase):
  ...
  def test_playthoughs_consistent(self):
    ...
    cc_playthrough = os.path.join(path, "new_game.txt")
    py_playthrough = os.path.join(path, "python_new_game.txt")
    ...
    self.assertEqual(
        diffs, {
            ...
            '- GameType.long_name = "New Game"\n',
            '+ GameType.long_name = "Python New Game"\n',
            '- GameType.short_name = "new_game"\n',
  ...
  def test_consistent(self):
    ...
    """
    py_game = pyspiel.load_game("python_new_game")
    cc_game = pyspiel.load_game("python_new_game")
